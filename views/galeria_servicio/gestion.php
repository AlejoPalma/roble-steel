<div class="container mb-5">
    <h2 class="mt-3 pt-2 text-center">Gestionar galeria de servicio</h2>
    <hr class="my-4">
    ...
    <div class="mb-4">
        <a class="btn btn-primary" style="background-color: #ac2bac;" href="<?= base_url ?>galeria_servicio/crear" role="button">
            añadir nueva imagen
        </a>
    </div>
                ...
                <div class="col-sm-6 col-md-6 col-lg-4 mb-4">
                    <div class="bg-image hover-zoom shadow-4 rounded-5 mb-3">
                        ...
                        <?php if ($imagen_galeria->imagen != null) : ?>
                            <img data-mdb-toggle="animation" data-mdb-animation-start="onScroll" data-mdb-animation-on-scroll="repeat" data-mdb-animation="fade-in" src="<?= base_url ?>uploads/galeria_servicio/<?= $imagen_galeria->imagen ?>" data-mdb-img="<?= base_url ?>uploads/galeria_servicio/<?= $imagen_galeria->imagen ?>" class="w-100" style="height: 250px;" />
                        <?php else : ?>
                    ...
                    <p class="fw-bold mb-2 text-center">
                        <?php
                        $nombreServicio = Utils::nombreServicio($imagen_galeria->id_servicio);
                        echo $nombreServicio;
                        ?>
                    </p>
                    <p class="fw-bold mb-1 text-center">
                        <a class="btn btn-primary btn-floating me-1" href="<?= base_url ?>galeria_servicio/editar&id=<?= $imagen_galeria->id ?>" role="button">
                            <i class="fas fa-edit"></i>
                        </a>
                        <a class="btn btn-primary btn-floating" style="background-color: #dd4b39;" href="<?= base_url ?>galeria_servicio/eliminar&id=<?= $imagen_galeria->id ?>" role="button">
